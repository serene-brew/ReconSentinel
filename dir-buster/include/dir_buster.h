/**
 * @file dir_buster.h
 * @brief Directory brute-forcing engine interface.
...
/**
 * @brief Single finding returned by DirBuster.
 */
struct Finding {
    std::string url;
    long status_code;
...
/**
 * @brief Concurrent directory brute-forcer using HTTP HEAD/GET probes.
 */
class DirBuster {
private:
    std::string base_url;
