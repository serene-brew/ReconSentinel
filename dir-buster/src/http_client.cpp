...
// Brief: Minimal curl-based HTTP GET/HEAD helpers used by DirBuster.
// Author: ImonChakraborty

#include <curl/curl.h>

size_t header_callback(char* buffer, size_t size, size_t nitems, void* userdata) {
    Response* resp = static_cast<Response*>(userdata);
...
/**
 * @brief Issue an HTTP GET request and collect headers/body.
 */
...
/**
 * @brief Issue an HTTP HEAD request (follow redirects) and capture status.
 */
